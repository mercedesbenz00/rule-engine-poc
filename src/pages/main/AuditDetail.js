...
import { addManager, updateManager} from '../../redux/actions';
    ...
    render(){  
        ...
        return (        
            <React.Fragment>
                <PageTitle
                    breadCrumbItems={[
                        { label: LangUtils.getLanguage(user.lang, 'navigation.Main Management'), path: '/main/manager' },
                        { label: LangUtils.getLanguage(user.lang, 'navigation.Manager Information'), path: '/main/manager' },
