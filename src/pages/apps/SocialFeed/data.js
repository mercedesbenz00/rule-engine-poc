...
const posts = [
    ...
    },
    {
        ...
        content:
            ...
            '<img src="' +
            img1 +
            '" alt="post-img" class="rounded mr-1 mb-3 mb-sm-0 img-fluid" /></div><div class="col">' +
            '<img src="' +
            img2 +
            '" alt="post-img" class="rounded mr-1 img-fluid mb-3" />' +
            '<img src="' +
            img3 +
            '" alt="post-img" class="rounded mr-1 img-fluid" /></div></div></div>',
        totalLikes: '1.2k',
        totalComments: '148',
        isLiked: false,
        comments: [
